...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <form action="{{ route('admin.posts.update', ['post' => $post->slug]) }}" method="post" enctype="multipart/form-data" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="mb-2">
                        <img class="img-thumbnail" style="width: 250px" src="{{asset('storage/' . $post->cover_img)}}">
                    </div>
                    <input type="file" name="cover_img" class="form-control-file @error('cover_img') is-invalid @enderror" value="{{ old('cover_img', $post->cover_img) }}">
                    @error('cover_img')
